...
namespace NRemedy.Core.Test
{
    ...
    public class ARProxyLambdaExtension_Delete_Test : RegularConfig
    {
        ...
        public void DeleteEntries_ArgumentNull_Exception()
        {
        ...
        public void DeleteEntries_single_condition()
        {
            ...
            try
            {
                ...
                proxy.DeleteEntries(m => m.CharacterField == TestCharacterFieldValue);
        ...
        public void DeleteEntries_string_contains_condition()
        {
            ...
            try
            {
                ...
                proxy.DeleteEntries(m => m.CharacterField.Contains(TestCharacterFieldValueChinese + "%") && m.IntegerField == 3);
